const CartSM = ({ ticketData }) => {
    return (
      <>
        <button className="btn hover:bg-[#242424] lg:hidden fixed right-5 top-12 z-20 transform bg-[#242424] -translate-y-1/2" onClick={() => document.getElementById('my_modal_1').showModal()}>Cart</button>
